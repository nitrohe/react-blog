...
const page2Data = [
  {
    img: require('./rmsportal/eYNnmGagLWdrkdMHVUuA.svg'),
    name: 'Ant Design Components',
  },
  {
    img: require('./rmsportal/slVtnOCcgeAcLEPwtewY.svg'),
    name: 'Blog v1.0',
    //slogan: (<FormattedMessage id="app.home.product-pro-slogan" />),
    slogan: '2017.04 - 开始搭建基于jquery和php的v1',
    link: 'https://pro.ant.design/index-cn',
  },
  {
    img: require('./rmsportal/EPaPtDVGnJhyqyBAUZMl.svg'),
    name: 'Blog v2.0',
    slogan: '2018.03 - 开始搭建基于react和nodejs的v2',
    //slogan: (<FormattedMessage id="app.home.product-mobile-slogan" />),
    link: 'https://mobile.ant.design/index-cn',
  },
  {
    img:  require('./rmsportal/GobRAKexhfTSJdLFzDFY.svg'),
    name: 'Blog v3.0',
    ...
    <svg width="100%" height="100%" viewBox="0 0 1401 1109" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" preserveAspectRatio="xMidYMid slice" >
      <g transform="translate(-79.000000, -21.000000)">
        ...
        <g id="Group-26" transform="translate(146.000000, 338.000000)" fill="#FADB14">
          <image xlinkHref={require('./rmsportal/UtBesTOkoZsBUxPqfDlZ.svg')} />
        </g>
      </g>
    </svg>
  ),
  (
    <svg width="1311px" height="920px" viewBox="0 0 1311 920" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="Group-29" transform="translate(283.000000, 920.000000)" fill="#2F54EB">
        <image xlinkHref={require('./rmsportal/VrADJaRPMnFjmtmIhObV.svg')} />
      </g>
      ...
      <g id="Group-11" transform="translate(1207.000000, 419.000000)" fill="#13C2C2">
        <image xlinkHref={require('./rmsportal/MnLEmwjipfhzPUmBJnJE.svg')} />
      </g>
      <g id="Group-28" transform="translate(884.000000, 821.000000)" fill="#2F54EB">
        <image xlinkHref={require('./rmsportal/dyNuxLOZtvjoHSVisbhQ.svg')} />
      </g>
    </svg>
  ),
];
...
export default function Page2({ isMobile, locale }) {
  ...
  const children = page2Data.map((item, i) => {
    ...
    const content = isMobile && !i ? componentButton : [
      ...
      <span className="more" key="a">{/*app.home.more<Icon type="right" />*/}</span>,
    ];
    return (
